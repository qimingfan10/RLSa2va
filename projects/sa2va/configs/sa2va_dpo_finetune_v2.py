...
# 使用预构建的tokenizer（已包含special tokens）
tokenizer = dict(
    type=AutoTokenizer.from_pretrained,
    pretrained_model_name_or_path=path,  # 使用原始tokenizer，训练时自动添加special tokens
...
sa2va_dpo_finetune_configs = [
    dict(
        ...
        data_prefix=dict(img_path='images/'),  # 图片在images目录下
