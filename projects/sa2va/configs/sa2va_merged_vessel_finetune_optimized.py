...
# Scheduler & Optimizer - 优化显存使用
batch_size = 1  # 每个GPU的批次大小
accumulative_counts = 16  # 增加梯度累积以减少显存压力
...
sa2va_merged_vessel_finetune_configs = [
    dict(
        ...
        name='MergedVesselSegmentationDataset',
        data_root=MERGED_VESSEL_ROOT,
...
# load from which checkpoint - 从之前的训练继续
load_from = '/home/ubuntu/Sa2VA/work_dirs/vessel_segmentation/iter_12192.pth'
...
# DeepSpeed strategy - 更激进的CPU offload来分散显存压力
strategy = dict(
    ...
    zero_optimization=dict(
        ...
        stage3_param_persistence_threshold=1e5,  # 更小的阈值
        stage3_max_live_parameters=5e7,  # 限制同时在GPU上的参数
